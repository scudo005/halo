 ...
 *   unlinked from the actor (actor_replace_prop_reference + FUN_00064400) and cleared to zero
 ...
 *   0x64785 actor_replace_prop_reference (3 stack args):
 ...
 *   coalescing this call's 3 pushes with actor_replace_prop_reference's 3 — the ARG_COUNT
...
int prop_new_unacknowledged(int actor_handle, int unit_handle, bool flag)
{
  ...
  if (prop_index == none_handle) {
    ...
    actor_replace_prop_reference(actor_handle, prop_index, none_handle);
